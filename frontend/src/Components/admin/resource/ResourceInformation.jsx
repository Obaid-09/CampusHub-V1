...
const ResourceInformation = ({ resource }) => {
  return (
    ...
    >
      ...
      <ResourceInfoRow label="Branch" value={resource.branch} />

      <ResourceInfoRow label="Semester" value={resource.semester} />

      <ResourceInfoRow label="Course Code" value={resource.courseCode} />

      <ResourceInfoRow label="Type" value={resource.type} />

      <ResourceInfoRow label="Status" value={resource.status} />
