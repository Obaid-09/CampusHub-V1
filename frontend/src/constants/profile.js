...
export const uploadedResources = dummyResources.slice(0, 6);
...
export const dummyProfile = {
  ...
  bio: "Pre-final year student at NIT Warangal. Passionate about Full Stack Development, Competitive Programming and AI.",
  branch: "EEE",
  semester: 5,
  year: 3,
