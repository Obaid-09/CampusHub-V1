  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-5 mt-6">
        <img
          src={uploader.avatar || "https://i.pravatar.cc/150"}
          alt=""
        ...
        <div>
          ...
          <p className="text-gray500">{uploader.college}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        <div className="bg-background rounded-xl p-4 text-center">
          ...
          <p className="text-gray500">Uploads</p>
        </div>
        <div className="bg-background rounded-xl p-4 text-center">
          <h3 className="text-2xl font-bold text-primary">⭐ 4.9</h3>
          <p className="text-gray500">Rating</p>
        </div>
      </div>
