...
const VerifyEmailCard = () => {
  return (
    <div className="text-center">
      <Mail size={70} className="mx-auto text-primary" />
      ...
      <Button className="w-full mt-8 h-14">Resend Email</Button>

      <Link to="/login" className="block mt-6 text-primary hover:underline">
        Back to Login
      </Link>
    </div>
  );
