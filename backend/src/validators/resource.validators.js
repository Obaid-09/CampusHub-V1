...
export const reportResourceValidator = [
...
export const uploadResourceValidator = [
  ...
  body("courseCode").optional().trim().toUpperCase(),

  body("branch")
    .notEmpty()
    .withMessage("Branch is required")
    .isIn(["CSE", "ECE", "EEE", "ME", "CE", "CHE", "MME", "BT", "Other"])
  ...
  body("examType")
    .optional()
    .isIn(["Mid Sem", "End Sem", "Quiz", "Assignment", "Other"]),
...
export const downloadResourceValidator = [...resourceIdValidator];

export const bookmarkResourceValidator = [...resourceIdValidator];

export const viewResourceValidator = [...resourceIdValidator];

export const deleteResourceValidator = [...resourceIdValidator];

export const getResourceByIdValidator = [...resourceIdValidator];
